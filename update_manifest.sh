...
for modpack_dir in modpacks/*/; do
  ...
  generate_manifest() {
    ...
    local BASE_URL="https://raw.githubusercontent.com/PoiBoy34/Launcher_cobblemon/main/modpacks/$MODPACK_NAME/$FOLDER_NAME"
  ...
  "files": [' > "$MANIFEST_FILE"
    ...
    if [ "$FOLDER_NAME" = "mods" ] && [ "$MODPACK_NAME" = "Cobblemon" ]; then
      ...
      "url": "https://github.com/PoiBoy34/Launcher_cobblemon/releases/download/mods-v1/Cobblemon-fabric-1.7.3+1.21.1.jar",
    ...
    if [ "$FOLDER_NAME" = "resourcepacks" ] && [ "$MODPACK_NAME" = "Cobblemon" ]; then
      ...
      "url": "https://github.com/PoiBoy34/Launcher_cobblemon/releases/download/mods-v1/COBBLEVERSE.Soundtrack.zip",
      "sha1": "b3a3d35c4e49e2dfee9c752b6287dcf107020708"
    },
    {
      "name": "JigglyRadio.zip",
      "url": "https://github.com/PoiBoy34/Launcher_cobblemon/releases/download/mods-v1/JigglyRadio.zip",
